...
# **createBackup**
> \Wodby\Api\Model\ResponseTask createBackup($data)
...
$data = new \Wodby\Api\Model\RequestBackupCreate(); // \Wodby\Api\Model\RequestBackupCreate | 

try {
    $result = $apiInstance->createBackup($data);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **data** | [**\Wodby\Api\Model\RequestBackupCreate**](../Model/RequestBackupCreate.md)|  |
...
# **deleteBackup**
> \Wodby\Api\Model\ResponseTask deleteBackup($id)
