...
```php
appDeploymentsFromCiPost($deployment_from_ci_input): \Wodby\Api\Model\AppDeployment
```
...
try {
    $result = $apiInstance->appDeploymentsFromCiPost($deployment_from_ci_input);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AppDeploymentsApi->appDeploymentsFromCiPost: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
appDeploymentsIdRedeployPost($id): \Wodby\Api\Model\AppDeployment
```
...
try {
    $result = $apiInstance->appDeploymentsIdRedeployPost($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AppDeploymentsApi->appDeploymentsIdRedeployPost: ', $e->getMessage(), PHP_EOL;
}
```
