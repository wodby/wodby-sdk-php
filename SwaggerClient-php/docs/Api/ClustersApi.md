...
```php
clustersGet($org_id, $project_ids, $integration_id): \Wodby\Api\Model\Cluster[]
```
...
try {
    $result = $apiInstance->clustersGet($org_id, $project_ids, $integration_id);
    print_r($result);
} catch (Exception $e) {
...
```php
clustersIdDelete($id, $force): \Wodby\Api\Model\OperationResult
```
...
try {
    $result = $apiInstance->clustersIdDelete($id, $force);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ClustersApi->clustersIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
clustersIdGet($id): \Wodby\Api\Model\Cluster
```
...
try {
    $result = $apiInstance->clustersIdGet($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ClustersApi->clustersIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
clustersIdPut($id, $update_title_request): \Wodby\Api\Model\Cluster
```
...
try {
    $result = $apiInstance->clustersIdPut($id, $update_title_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ClustersApi->clustersIdPut: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
clustersPost($new_cluster_input): \Wodby\Api\Model\Cluster
```
...
try {
    $result = $apiInstance->clustersPost($new_cluster_input);
    print_r($result);
} catch (Exception $e) {
