...
/**
 * ProviderManifestUpdateInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class ProviderManifestUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProviderManifestUpdateInput';
    ...
    */
     ...
     * Sets manifest_yaml
     *
     * @param string $manifest_yaml Complete versioned variable provider manifest YAML.
     *
     * @return self
     */
