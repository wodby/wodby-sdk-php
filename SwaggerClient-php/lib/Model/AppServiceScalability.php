...
/**
 * AppServiceScalability Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class AppServiceScalability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppServiceScalability';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['average_cpu'] === null) {
            $invalidProperties[] = "'average_cpu' can't be null";
        }
     ...
     * Sets average_cpu
     *
     * @param int $average_cpu average_cpu
     *
     * @return self
     */
    public function setAverageCpu($average_cpu)
    {
        if (is_null($average_cpu)) {
            throw new \InvalidArgumentException('non-nullable average_cpu cannot be null');
        }
