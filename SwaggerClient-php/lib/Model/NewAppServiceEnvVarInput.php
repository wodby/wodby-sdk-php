...
/**
 * NewAppServiceEnvVarInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class NewAppServiceEnvVarInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewAppServiceEnvVarInput';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling NewAppServiceEnvVarInput., must be bigger than or equal to 1.');
        }
     ...
     * Sets runtime
     *
     * @param bool|null $runtime runtime
     *
     * @return self
     */
