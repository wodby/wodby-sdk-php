...
/**
 * StackAutoOriginUpdateVersionPolicyInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class StackAutoOriginUpdateVersionPolicyInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StackAutoOriginUpdateVersionPolicyInput';
    ...
    */
     ...
     * Sets allow_patch
     *
     * @param bool|null $allow_patch allow_patch
     *
     * @return self
     */
    public function setAllowPatch($allow_patch)
    {
        if (is_null($allow_patch)) {
            array_push($this->openAPINullablesSetToNull, 'allow_patch');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allow_patch', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets allow_minor
     *
     * @param bool|null $allow_minor allow_minor
     *
     * @return self
     */
    public function setAllowMinor($allow_minor)
    {
        if (is_null($allow_minor)) {
            array_push($this->openAPINullablesSetToNull, 'allow_minor');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allow_minor', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets allow_major
     *
     * @param bool|null $allow_major allow_major
     *
     * @return self
     */
    public function setAllowMajor($allow_major)
    {
        if (is_null($allow_major)) {
            array_push($this->openAPINullablesSetToNull, 'allow_major');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allow_major', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
