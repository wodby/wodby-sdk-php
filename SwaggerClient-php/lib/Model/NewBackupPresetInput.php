...
class NewBackupPresetInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('backup_category', $data ?? [], 'any');
    ...
    */
     ...
     * Sets env_types
     *
     * @param string[]|null $env_types env_types
     *
     * @return self
     */
     ...
     *
     * @param string|null $backup_category backup_category
     *
     * @return self
     */
     ...
     * Sets integration_id
     *
     * @param int $integration_id Use 0 for Wodby Blob Storage. Free subscriptions may create only an automatic preset that is disabled.
     *
     * @return self
     */
