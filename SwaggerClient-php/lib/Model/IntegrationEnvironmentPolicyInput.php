 ...
 */
class IntegrationEnvironmentPolicyInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationEnvironmentPolicyInput';
