...
/**
 * AppEnvironmentCICDSettingsInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class AppEnvironmentCICDSettingsInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppEnvironmentCICDSettingsInput';
    ...
    */
     ...
     *
     * @param int $ci_integration_id CI integration ID. Set to zero to use the built-in Wodby CI service.
     *
     * @return self
     */
     ...
     *
     * @param int $registry_integration_id Registry integration ID. Set to zero to use the built-in Wodby registry service.
     *
     * @return self
     */
