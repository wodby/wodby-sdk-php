...
/**
 * HelmChartVolumeClaim Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class HelmChartVolumeClaim implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelmChartVolumeClaim';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('access_modes', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets access_modes
     *
     * @param string[]|null $access_modes access_modes
     *
     * @return self
     */
    public function setAccessModes($access_modes)
    {
        if (is_null($access_modes)) {
            throw new \InvalidArgumentException('non-nullable access_modes cannot be null');
        }
