...
/**
 * AppServiceDeploymentRequest Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class AppServiceDeploymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppServiceDeploymentRequest';
    ...
    */
     ...
     *
     * @param bool|null $skip_post_deployment skip_post_deployment
     *
     * @return self
     */
    public function setSkipPostDeployment($skip_post_deployment)
    {
        if (is_null($skip_post_deployment)) {
            array_push($this->openAPINullablesSetToNull, 'skip_post_deployment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('skip_post_deployment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
