...
/**
 * AppServiceBuildConfig Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class AppServiceBuildConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppServiceBuildConfig';
    ...
    */
     ...
     * Sets dockerfile
     *
     * @param string|null $dockerfile dockerfile
     *
     * @return self
     */
    public function setDockerfile($dockerfile)
    {
        if (is_null($dockerfile)) {
            array_push($this->openAPINullablesSetToNull, 'dockerfile');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dockerfile', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * @return string|null
     */
    public function getDockerignore()
    {
        return $this->container['dockerignore'];
    }

    /**
     * Sets dockerignore
     *
     * @param string|null $dockerignore dockerignore
     *
     * @return self
     */
    public function setDockerignore($dockerignore)
    {
        if (is_null($dockerignore)) {
            array_push($this->openAPINullablesSetToNull, 'dockerignore');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dockerignore', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dockerignore'] = $dockerignore;
     ...
     * Gets args
     *
     * @return \Wodby\Api\Model\AppServiceBuildArg[]|null
     */
     ...
     * Sets args
     *
     * @param \Wodby\Api\Model\AppServiceBuildArg[]|null $args args
     *
     * @return self
     */
