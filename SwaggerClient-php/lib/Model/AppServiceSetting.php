...
/**
 * AppServiceSetting Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class AppServiceSetting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppServiceSetting';
    ...
    protected static $setters = [
        ...
        'runtime' => 'setRuntime',
        'build' => 'setBuild',
        'from_setting_id' => 'setFromSettingId'
    ];
    ...
    protected static $getters = [
        ...
        'runtime' => 'getRuntime',
        'build' => 'getBuild',
        'from_setting_id' => 'getFromSettingId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('from_setting_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($var)) {
            throw new \InvalidArgumentException('non-nullable var cannot be null');
        }
        $this->container['var'] = $var;
    ...
    /**
     * Gets from_setting_id
     *
     * @return int|null
     */
    public function getFromSettingId()
    {
        return $this->container['from_setting_id'];
    }

    /**
     * Sets from_setting_id
     *
     * @param int|null $from_setting_id from_setting_id
     *
     * @return self
     */
    public function setFromSettingId($from_setting_id)
    {
        if (is_null($from_setting_id)) {
            array_push($this->openAPINullablesSetToNull, 'from_setting_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('from_setting_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['from_setting_id'] = $from_setting_id;
