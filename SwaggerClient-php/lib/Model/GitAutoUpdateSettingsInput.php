...
/**
 * GitAutoUpdateSettingsInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class GitAutoUpdateSettingsInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GitAutoUpdateSettingsInput';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('semver_tags', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['semver_tags'] === null) {
            $invalidProperties[] = "'semver_tags' can't be null";
        }
     ...
     * @return bool
     */
    public function getSemverTags()
    {
        return $this->container['semver_tags'];
    }

    /**
     * Sets semver_tags
     *
     * @param bool $semver_tags semver_tags
     *
     * @return self
     */
    public function setSemverTags($semver_tags)
    {
        if (is_null($semver_tags)) {
            throw new \InvalidArgumentException('non-nullable semver_tags cannot be null');
        }
        $this->container['semver_tags'] = $semver_tags;
