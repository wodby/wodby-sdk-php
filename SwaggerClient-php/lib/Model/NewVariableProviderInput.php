...
/**
 * NewVariableProviderInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class NewVariableProviderInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewVariableProviderInput';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'title' => 'string',
        'fields' => '\Wodby\Api\Model\NewVariableProviderFieldInput[]'
    ];
    ...
    */
     ...
     * Gets fields
     *
     * @return \Wodby\Api\Model\NewVariableProviderFieldInput[]
     */
     ...
     * Sets fields
     *
     * @param \Wodby\Api\Model\NewVariableProviderFieldInput[] $fields fields
     *
     * @return self
     */
    public function setFields($fields)
    {
        ...
        if ((count($fields) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fields when calling NewVariableProviderInput., number of items must be greater than or equal to 1.');
        }
