...
class App implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cluster_app'] === null) {
            $invalidProperties[] = "'cluster_app' can't be null";
        }
     ...
     * @return bool
     */
    public function getClusterApp()
    {
        return $this->container['cluster_app'];
    }

    /**
     * Sets cluster_app
     *
     * @param bool $cluster_app cluster_app
     *
     * @return self
     */
    public function setClusterApp($cluster_app)
    {
        if (is_null($cluster_app)) {
            throw new \InvalidArgumentException('non-nullable cluster_app cannot be null');
        }
        $this->container['cluster_app'] = $cluster_app;
