...
/**
 * ManifestFromYAMLInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class ManifestFromYAMLInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManifestFromYAMLInput';
    ...
    */
     ...
     * Sets version
     *
     * @param string|null $version Optional revision version label for the generated non-Git resource.
     *
     * @return self
     */
     ...
     * Sets manifest_yaml
     *
     * @param string $manifest_yaml Complete Wodby service.yml or stack.yml manifest content.
     *
     * @return self
     */
