...
/**
 * ProviderManifestInput Class Doc Comment
 *
 * @category Class
 * @package  Wodby\Api
 * @author   OpenAPI Generator team
 ...
 */
class ProviderManifestInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProviderManifestInput';
    ...
    */
     ...
     * Sets manifest_yaml
     *
     * @param string $manifest_yaml Complete variable provider manifest YAML.
     *
     * @return self
     */
