...
class Instance implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['stack_version'] = isset($data['stack_version']) ? $data['stack_version'] : null;
     ...
     * Sets build
     *
     * @param \Wodby\Api\Model\Build $build build
     *
     * @return $this
     */
