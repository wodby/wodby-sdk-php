...
class BackupApi
{
     ...
     *
     * @param  \Wodby\Api\Model\RequestBackupCreate $data  (required)
     *
    ...
    {
        list($response) = $this->createBackupWithHttpInfo($data);
        return $response;
    }
     ...
     */
    public function createBackupWithHttpInfo($data)
    {
        $returnType = '\Wodby\Api\Model\ResponseTask';
        $request = $this->createBackupRequest($data);
     ...
     */
    public function createBackupAsync($data)
    {
        return $this->createBackupAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBackupAsyncWithHttpInfo($data)
    {
        $returnType = '\Wodby\Api\Model\ResponseTask';
        $request = $this->createBackupRequest($data);
     ...
     */
    protected function createBackupRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling createBackup'
            );
        }
    ...
    {
        list($response) = $this->deleteBackupWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array of \Wodby\Api\Model\ResponseTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteBackupWithHttpInfo($id)
    {
        $returnType = '\Wodby\Api\Model\ResponseTask';
        $request = $this->deleteBackupRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBackupAsync($id)
    {
        return $this->deleteBackupAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBackupAsyncWithHttpInfo($id)
    {
        $returnType = '\Wodby\Api\Model\ResponseTask';
        $request = $this->deleteBackupRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteBackupRequest($id)
    {
